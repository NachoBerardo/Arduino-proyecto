...
void loop() {
  ...
  {
    Serial.println("FAVORABLE PARA SEMAFORO 1");
  ...
  {
    Serial.println("MUY FAVORABLE PARA SEMAFORO 1");
  ...
  {
    Serial.println("POCO PARA SEMAFORO 1");
  ...
  {
    Serial.println("MUY POCO FAVORABLE PARA SEMAFORO 1");
